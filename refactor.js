  ...
  <div class="max-w-[90rem] mx-auto px-5 md:px-12">
    <div class="flex flex-col md:flex-row items-center justify-between mb-12 gap-6">
      <div>
        ...
        <p class="text-muted text-[13px] md:text-sm">Follow <a href="https://www.instagram.com/kgshomedecors_virudhachalam" target="_blank" class="text-ink font-semibold hover:text-gold transition-colors">@kgshomedecors_virudhachalam</a> for daily inspiration.</p>
      </div>
      <a href="https://www.instagram.com/kgshomedecors_virudhachalam" target="_blank" class="btn-secondary whitespace-nowrap">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
      <a href="https://www.instagram.com/kgshomedecors_virudhachalam" target="_blank" class="group relative aspect-square overflow-hidden bg-tint rounded-md block">
